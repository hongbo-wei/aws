...
// const prompt = "Give me an affirmation to boost my motivation today, telling me that I will get a decent job at Amazon Web Service (AWS) soon, referencing success by adding emoji. Don't show the prompt, only the quote. Do not add anything like Here is an affirmation... just return the affirmation alone";
const prompt = "Give me an affirmation to boost my motivation today, telling me that I will become a world boxing champion, referencing success by adding emoji. Don't show the prompt, only the quote. Do not add anything like Here is an affirmation... just return the affirmation alone";
const conversation = [
  {
    role: "user",
    content: [{ text: prompt }],
